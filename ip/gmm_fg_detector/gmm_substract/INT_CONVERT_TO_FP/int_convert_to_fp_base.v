...
// ============================================================
// File Name: int_convert_to_fp_base.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=21 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=21 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=21 WIDTHDIST=5 aclr clk_en clock data distance result
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ  VERSION_END

//synthesis_resources = reg 46 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altbarrel_shift_dof
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[20:0]	sbit_piper1d;
	reg	[20:0]	sbit_piper2d;
	reg	sel_pipec3r1d;
	reg	sel_pipec4r1d;
	wire  [5:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 21'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[62:42];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 21'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[104:84];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {16{1'b0}},
		result = sbit_w[125:105],
		sbit_w = {sbit_piper2d, smux_w[83:63], sbit_piper1d, smux_w[41:0], data},
		sel_w = {sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({21{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[88:84], pad_w[15:0]}) | ({21{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[104:100]})) | ({21{(~ sel_w[4])}} & sbit_w[104:84])), ((({21{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[75:63], pad_w[7:0]}) | ({21{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[83:71]})) | ({21{(~ sel_w[3])}} & sbit_w[83:63])), ((({21{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[58:42], pad_w[3:0]}) | ({21{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[62:46]})) | ({21{(~ sel_w[2])}} & sbit_w[62:42])), ((({21{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[39:21], pad_w[1:0]}) | ({21{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[41:23]})) | ({21{(~ sel_w[1])}} & sbit_w[41:21])), ((({21{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[19:0], pad_w[0]}) | ({21{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[20:1]})) | ({21{(~ sel_w[0])}} & sbit_w[20:0]))};
endmodule //int_convert_to_fp_base_altbarrel_shift_dof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //int_convert_to_fp_base_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //int_convert_to_fp_base_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	int_convert_to_fp_base_altpriority_encoder_3v7   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q));
	int_convert_to_fp_base_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	int_convert_to_fp_base_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	int_convert_to_fp_base_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	int_convert_to_fp_base_altpriority_encoder_6v7   altpriority_encoder10
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder10_q));
	int_convert_to_fp_base_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[7:4]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	int_convert_to_fp_base_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	int_convert_to_fp_base_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	int_convert_to_fp_base_altpriority_encoder_bv7   altpriority_encoder8
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder8_q));
	int_convert_to_fp_base_altpriority_encoder_be8   altpriority_encoder9
	( 
	.data(data[15:8]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	int_convert_to_fp_base_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	int_convert_to_fp_base_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[15:8]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	int_convert_to_fp_base_altpriority_encoder_r08   altpriority_encoder6
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder6_q));
	int_convert_to_fp_base_altpriority_encoder_rf8   altpriority_encoder7
	( 
	.data(data[31:16]),
...
endmodule //int_convert_to_fp_base_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 176 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_to_fp_base_altfp_convert_hsn
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [20:0]   wire_altbarrel_shift5_result;
	...
	reg	[19:0]	mag_int_a_reg;
	reg	[19:0]	mag_int_a_reg2;
	...
	reg	sign_int_a_reg4;
	reg	sign_int_a_reg5;
	wire  [19:0]   wire_add_sub1_result;
	...
	wire  [20:0]  prio_mag_int_a;
	wire  [10:0]  priority_pad_one_w;
	wire  [31:0]  result_w;
	wire  [19:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [2:0]  zero_padding_w;

	int_convert_to_fp_base_altbarrel_shift_dof   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	int_convert_to_fp_base_altpriority_encoder_qb6   altpriority_encoder2
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 20'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 20'b0;
	...
	.cout(),
	.dataa(invert_int_a),
	.datab(20'b00000000000000000001),
	.overflow(),
	...
	assign
		...
		const_bias_value_add_width_int_w = 8'b10010010,
		...
		mag_int_a = (({20{(~ sign_int_a)}} & int_a) | ({20{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[22:0],
		mantissa_pre_round = {shifted_mag_int_a[19:0], {4{1'b0}}},
		mantissa_rounded = mantissa_pre_round_reg,
		max_neg_value_selector = (wire_cmpr4_alb & sign_int_a_reg2),
		max_neg_value_w = 8'b10010011,
		minus_leading_zero = {zero_padding_w, leading_zeroes},
		prio_mag_int_a = {mag_int_a_reg, 1'b1},
		priority_pad_one_w = {11{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift5_result[19:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[20],
		zero_padding_w = {3{1'b0}};
endmodule //int_convert_to_fp_base_altfp_convert_hsn
//VALID FILE
...
module int_convert_to_fp_base (
	...
	int_convert_to_fp_base_altfp_convert_hsn	int_convert_to_fp_base_altfp_convert_hsn_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: CONSTANT: WIDTH_DATA NUMERIC "21"
// Retrieval info: CONSTANT: WIDTH_EXP_INPUT NUMERIC "8"
// Retrieval info: CONSTANT: WIDTH_EXP_OUTPUT NUMERIC "8"
// Retrieval info: CONSTANT: WIDTH_INT NUMERIC "21"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL int_convert_to_fp_base.cmp FALSE TRUE
