// soc_system_alt_vip_cl_vfb_gmm_video_in.v
...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_vfb_gmm_video_in (
		input  wire         main_clock_clk,              //    main_clock.clk
		input  wire         main_reset_reset,            //    main_reset.reset
		input  wire [127:0] av_st_vid_din_data,          // av_st_vid_din.data
		...
		input  wire [3:0]   av_st_vid_din_empty,         //              .empty
		...
		output wire [163:0] av_st_dout_data,             //              .data
		input  wire         av_st_dout_ready             //              .ready
	);

	wire          vid_front_av_st_dout_valid;         // vid_front:av_st_dout_valid -> vid_back:av_st_din_valid
	wire  [163:0] vid_front_av_st_dout_data;          // vid_front:av_st_dout_data -> vid_back:av_st_din_data
	...
	alt_vip_video_input_bridge_resp #(
		...
		.av_st_vid_din_empty         (av_st_vid_din_empty),                //              .empty
