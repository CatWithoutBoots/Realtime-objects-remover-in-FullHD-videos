// soc_system_alt_vip_cl_vfb_gmm.v
...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_vfb_gmm #(
		...
		parameter MEM_BASE_ADDR                = 20971520,
		...
		parameter MAX_SYMBOLS_PER_PACKET       = 32,
	...
	wire  [163:0] video_in_av_st_dout_data;              // video_in:av_st_dout_data -> wr_ctrl:vib_data_data
	...
	wire  [163:0] wr_ctrl_pkt_wr_data_data;              // wr_ctrl:pkt_wr_data_data -> pkt_trans_wr:av_st_din_data
	...
	wire  [163:0] rd_ctrl_vob_data_data;                 // rd_ctrl:vob_data_data -> video_out:av_st_din_data
	...
	wire  [163:0] pkt_trans_rd_av_st_dout_data;          // pkt_trans_rd:av_st_dout_data -> rd_ctrl:pkt_rd_data_data
	...
	soc_system_alt_vip_cl_vfb_gmm_video_in video_in (
		...
		.av_st_vid_din_empty         (din_empty),                         //              .empty
	...
	alt_vip_video_output_bridge #(
		...
		.av_st_vid_dout_empty         (dout_empty),                     //               .empty
