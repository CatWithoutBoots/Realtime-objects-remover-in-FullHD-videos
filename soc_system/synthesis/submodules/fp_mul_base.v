...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
...
module  fp_mul_base_altfp_mult_aoo
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_mul_base_altfp_mult_aoo
//VALID FILE
...
module fp_mul_base (
	...
	fp_mul_base_altfp_mult_aoo	fp_mul_base_altfp_mult_aoo_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fp_mul_base.cmp FALSE TRUE
